'use strict';
const DEFAULT_PRACTICAL_MARKS_CONFIG = {
  '11th': {
    internal: {
 ...
 */
function getSubjectMarksConfig(settings, cls = '11th', evalType = 'internal', subCode = 'PH') {
 ...
 */
module.exports = { DEFAULT_PRACTICAL_MARKS_CONFIG, getSubjectMarksConfig };
