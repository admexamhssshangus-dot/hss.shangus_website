...
export const ADMIN_MODULE_CATALOG = Object.freeze([
  ...
  // CATEGORY 2: Academics & Controls (5 Modules)
  {
    ...
    shortLabel: 'Controls',
    description: 'Class admission windows, academic session year, faculty portals, email automations, cloud storage quota health & annual session rollover',
    category: 'Academics & Controls',
    maturity: 'optimized',
    maturityNote: 'Atomic session controls, admission window toggles, cloud storage quota health & space reclamation, and audited configuration safeguards.',
    launcher: true,
    isNew: false,
