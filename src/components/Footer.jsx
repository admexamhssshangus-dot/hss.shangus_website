            ...
            {activeModal === 'privacy' && (
              <div>
                ...
                <div className="space-y-4 text-[12px] md:text-sm text-slate-650 leading-relaxed">
                  ...
                  <p><strong className="text-slate-800">5. Support & Corrections:</strong> To check your registered details or request corrections, contact the administrative desk at <a href="mailto:adm.exam.hss.shangus@gmail.com" className="text-[var(--teal-accent)] hover:underline underline-offset-2">adm.exam.hss.shangus@gmail.com</a>.</p>
                </div>
