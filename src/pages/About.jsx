      ...
      <div className="relative w-full overflow-hidden isolate">
        ...
        <div className="max-w-6xl mx-auto px-3 sm:px-4 py-8 sm:py-12 relative -mt-10 sm:-mt-16 z-20">
          <div className="bg-white rounded-2xl shadow-xl p-3.5 sm:p-8 border-t-4 border-teal-500 mb-6 sm:mb-8 relative overflow-hidden border border-slate-200/80">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 mb-4 sm:mb-5 relative z-10 border-b border-teal-100/80 pb-3">
              <div className="flex items-center gap-2.5">
                <div className="p-2 rounded-xl bg-teal-500/10 text-teal-700 flex-shrink-0">
              ...
              >
                ...
                <ChevronDown size={15} className={`transition-transform duration-300 ${showFullGlimpse ? 'rotate-180' : ''}`} />
              </button>
            </div>

            {/* Brief Single Summary Paragraph */}
            <div className="relative overflow-hidden rounded-xl p-3.5 sm:p-5 bg-teal-50/60 border border-teal-200/80 shadow-xs relative z-10 space-y-3 mb-4">
              <p className="text-slate-800 leading-relaxed text-xs xs:text-[13.5px] sm:text-base font-medium">
              ...
              <div className="flex flex-wrap items-center gap-1.5 sm:gap-2 pt-1">
                <span className="inline-flex items-center gap-1 px-2.5 py-1 rounded-lg bg-teal-100 text-teal-900 border border-teal-300/80 text-[11px] sm:text-xs font-bold">
                  <Sparkles size={12} className="text-teal-700 shrink-0" />
                  Est. 1917 Heritage
                </span>
                <span className="inline-flex items-center gap-1 px-2.5 py-1 rounded-lg bg-emerald-100 text-emerald-900 border border-emerald-300/80 text-[11px] sm:text-xs font-bold">
                  <GraduationCap size={12} className="text-emerald-700 shrink-0" />
                  Higher Secondary (2005)
                </span>
                <span className="inline-flex items-center gap-1 px-2.5 py-1 rounded-lg bg-amber-100 text-amber-900 border border-amber-300/80 text-[11px] sm:text-xs font-bold">
                  <Award size={12} className="text-amber-700 shrink-0" />
                  Academic Distinctions
                </span>
                <span className="inline-flex items-center gap-1 px-2.5 py-1 rounded-lg bg-indigo-100 text-indigo-900 border border-indigo-300/80 text-[11px] sm:text-xs font-bold">
                  <Globe size={12} className="text-indigo-700 shrink-0" />
                  Kachwan to Uttresoo
                </span>
              </div>
            </div>
            ...
            {showFullGlimpse && (
              <div ref={fullGlimpseRef} className="space-y-3.5 pt-2 animate-fadeIn relative z-10 scroll-mt-20">
                ...
                <div className="relative overflow-hidden rounded-xl p-3.5 sm:p-5 bg-gradient-to-br from-teal-50 to-emerald-50/70 border border-teal-200 shadow-xs hover:shadow-md transition-all duration-300 group">
                  <h4 className="text-sm xs:text-base sm:text-lg font-bold text-teal-950 mb-1.5 sm:mb-2 relative z-10 group-hover:text-teal-800 transition-colors">A Haven of Learning in the Heart of the Kashmir Valley</h4>
                  <p className="text-slate-800 leading-relaxed text-xs xs:text-sm sm:text-[14.5px] relative z-10 font-medium">
                ...
                <div className="relative overflow-hidden rounded-xl p-3.5 sm:p-5 bg-gradient-to-bl from-amber-50 to-orange-50/70 border border-amber-200 shadow-xs hover:shadow-md transition-all duration-300 group">
                  <h4 className="text-sm xs:text-base sm:text-lg font-bold text-amber-950 mb-1.5 sm:mb-2 relative z-10 group-hover:text-amber-800 transition-colors">A Legacy of Education Since 1917</h4>
                  <p className="text-slate-800 leading-relaxed text-xs xs:text-sm sm:text-[14.5px] relative z-10 font-medium">
                ...
                <div className="relative overflow-hidden rounded-xl p-3.5 sm:p-5 bg-gradient-to-br from-indigo-50 to-blue-50/70 border border-indigo-200 shadow-xs hover:shadow-md transition-all duration-300 group">
                  <h4 className="text-sm xs:text-base sm:text-lg font-bold text-indigo-950 mb-1.5 sm:mb-2 relative z-10 group-hover:text-indigo-800 transition-colors">Excellence in Academics and Beyond</h4>
                  <p className="text-slate-800 leading-relaxed text-xs xs:text-sm sm:text-[14.5px] relative z-10 font-medium">
                ...
                <div className="relative overflow-hidden rounded-xl p-3.5 sm:p-5 bg-gradient-to-bl from-rose-50 to-pink-50/70 border border-rose-200 shadow-xs hover:shadow-md transition-all duration-300 group">
                  <h4 className="text-sm xs:text-base sm:text-lg font-bold text-rose-950 mb-1.5 sm:mb-2 relative z-10 group-hover:text-rose-800 transition-colors">Shaping Tomorrow's Leaders</h4>
                  <p className="text-slate-800 leading-relaxed text-xs xs:text-sm sm:text-[14.5px] relative z-10 font-medium">
            ...
            {/* CTA */}
            <div className="pt-3.5 mt-2 border-t border-slate-200 relative z-10">
              <h4 className="text-xs sm:text-sm font-bold text-teal-800 mb-1">Explore, Discover, Connect</h4>
              <p className="text-slate-700 text-xs sm:text-[13.5px] font-medium leading-relaxed">Tour our vibrant campus, explore our curriculum, and connect with our admissions team to learn more!</p>
            </div>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-8">
            {/* VISION CARD */}
            <div className="relative overflow-hidden rounded-2xl border border-amber-200 bg-white bg-gradient-to-br from-white to-amber-50/60 p-4 sm:p-8 shadow-sm hover:shadow-xl transition-all duration-300 hover:-translate-y-1 group">
              <div className="absolute right-4 bottom-[-10px] text-7xl sm:text-8xl font-black text-amber-500/10 select-none pointer-events-none group-hover:scale-110 transition-transform duration-500">
                V
              </div>
              
              <div className="flex items-start gap-3.5 sm:gap-4">
                <div className="p-2.5 sm:p-3.5 rounded-xl bg-amber-500 text-white shadow-md shadow-amber-500/20 group-hover:rotate-6 transition-transform duration-300 flex-shrink-0">
                  <Eye size={22} className="stroke-[2]" />
                </div>
                <div className="space-y-2">
                  <h4 className="text-lg sm:text-xl font-bold text-slate-950 tracking-wide">
                    Vision
                  </h4>
                  <div className="w-10 sm:w-12 h-1 bg-amber-500 rounded-full" />
                  <p className="text-slate-800 leading-relaxed text-xs xs:text-sm md:text-[14.5px] font-medium">
            ...
            {/* MISSION CARD */}
            <div className="relative overflow-hidden rounded-2xl border border-teal-200 bg-white bg-gradient-to-br from-white to-teal-50/60 p-4 sm:p-8 shadow-sm hover:shadow-xl transition-all duration-300 hover:-translate-y-1 group">
              <div className="absolute right-4 bottom-[-10px] text-7xl sm:text-8xl font-black text-teal-500/10 select-none pointer-events-none group-hover:scale-110 transition-transform duration-500">
                M
              </div>

              <div className="flex items-start gap-3.5 sm:gap-4">
                <div className="p-2.5 sm:p-3.5 rounded-xl bg-teal-600 text-white shadow-md shadow-teal-600/20 group-hover:rotate-6 transition-transform duration-300 flex-shrink-0">
                ...
                <div className="space-y-2">
                  ...
                  <div className="w-10 sm:w-12 h-1 bg-teal-600 rounded-full" />
                  <p className="text-slate-800 leading-relaxed text-xs xs:text-sm md:text-[14.5px] font-medium">
        ...
        <div className="max-w-6xl mx-auto px-3 sm:px-4 py-8 sm:py-12">
          <h3 className="text-xl sm:text-2xl md:text-3xl font-extrabold text-slate-900 mb-6 sm:mb-8 text-center font-heading">Why Choose Govt. HSS Shangus?</h3>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-6">
            <div className="relative overflow-hidden bg-white p-4 sm:p-6 rounded-2xl shadow-sm border border-slate-200/90 text-center flex flex-col items-center hover:shadow-xl hover:-translate-y-1 transition-all duration-300 group border-t-4 border-t-teal-500">
              <div className="inline-flex items-center justify-center w-11 h-11 sm:w-13 sm:h-13 rounded-2xl bg-teal-50 border border-teal-200 text-teal-700 mb-3 sm:mb-4 transition-transform duration-300 group-hover:scale-110 shadow-xs">
                <Users size={22} className="stroke-[2.5]" />
              </div>
              <h4 className="font-bold text-slate-900 text-sm sm:text-base mb-1">Experienced Faculty</h4>
            ...
            <div className="relative overflow-hidden bg-white p-4 sm:p-6 rounded-2xl shadow-sm border border-slate-200/90 text-center flex flex-col items-center hover:shadow-xl hover:-translate-y-1 transition-all duration-300 group border-t-4 border-t-indigo-500">
              <div className="inline-flex items-center justify-center w-11 h-11 sm:w-13 sm:h-13 rounded-2xl bg-indigo-50 border border-indigo-200 text-indigo-700 mb-3 sm:mb-4 transition-transform duration-300 group-hover:scale-110 shadow-xs">
                <BookOpen size={22} className="stroke-[2.5]" />
              </div>
              <h4 className="font-bold text-slate-900 text-sm sm:text-base mb-1">Modern Labs &amp; Library</h4>
            ...
            <div className="relative overflow-hidden bg-white p-4 sm:p-6 rounded-2xl shadow-sm border border-slate-200/90 text-center flex flex-col items-center hover:shadow-xl hover:-translate-y-1 transition-all duration-300 group border-t-4 border-t-amber-500">
              <div className="inline-flex items-center justify-center w-11 h-11 sm:w-13 sm:h-13 rounded-2xl bg-amber-50 border border-amber-200 text-amber-700 mb-3 sm:mb-4 transition-transform duration-300 group-hover:scale-110 shadow-xs">
                <Award size={22} className="stroke-[2.5]" />
              </div>
              <h4 className="font-bold text-slate-900 text-sm sm:text-base mb-1">Strong Results</h4>
            ...
            <div className="relative overflow-hidden bg-white p-4 sm:p-6 rounded-2xl shadow-sm border border-slate-200/90 text-center flex flex-col items-center hover:shadow-xl hover:-translate-y-1 transition-all duration-300 group border-t-4 border-t-rose-500">
              <div className="inline-flex items-center justify-center w-11 h-11 sm:w-13 sm:h-13 rounded-2xl bg-rose-50 border border-rose-200 text-rose-700 mb-3 sm:mb-4 transition-transform duration-300 group-hover:scale-110 shadow-xs">
                <Globe size={22} className="stroke-[2.5]" />
              </div>
              <h4 className="font-bold text-slate-900 text-sm sm:text-base mb-1">Holistic Education</h4>
        ...
        <div className="max-w-6xl mx-auto px-3 sm:px-4 py-8 sm:py-12 border-t border-slate-200/80">
          <div className="grid md:grid-cols-2 gap-6 sm:gap-8 items-start">
            <div>
              <h3 className="text-xl sm:text-2xl font-bold text-slate-900 mb-3 font-heading">Our Story</h3>
              <p className="text-slate-800 leading-relaxed text-xs xs:text-sm font-medium">From modest beginnings to a premier local institution, Govt. HSS Shangus has steadily expanded its academic offerings and infrastructure to meet the needs of families across Anantnag. Our commitment to inclusion and quality has guided our growth.</p>
              
              <div className="relative pl-5 sm:pl-6 border-l-2 border-teal-300 space-y-5 sm:space-y-6 mt-6 sm:mt-8">
                {[
                  ...
                  <div key={i} className="relative group">
                    {/* Timeline Dot */}
                    <span className="absolute -left-[27px] sm:-left-[31px] top-1 w-3.5 h-3.5 sm:w-4 sm:h-4 rounded-full border-2 border-teal-600 bg-white group-hover:bg-teal-600 transition-colors duration-250 shadow-xs" />
                    <div>
                      <span className="inline-block px-2 sm:px-2.5 py-0.5 rounded-md bg-teal-100 border border-teal-300/80 text-teal-900 font-extrabold text-[10px] sm:text-[11px] mb-1">{item.year}</span>
                      <h4 className="font-bold text-slate-900 text-xs sm:text-sm mb-0.5">{item.title}</h4>
                      <p className="text-[11px] sm:text-[13px] text-slate-700 font-medium leading-relaxed">{item.desc}</p>
                    </div>
                  </div>
                ))}
              </div>
            </div>
            <div className="bg-white rounded-2xl p-4 sm:p-8 border border-slate-200/90 shadow-sm flex flex-col items-start gap-3 sm:gap-4">
              <div className="p-2.5 rounded-xl bg-teal-50 text-teal-700 border border-teal-200/60 mb-0.5">
                <Landmark size={22} />
              </div>
              <h4 className="text-base sm:text-xl font-bold text-slate-900 font-heading">Get Involved</h4>
              ...
              <Link to="/admissions" className="btn-primary-custom px-5 sm:px-6 py-2 sm:py-2.5 rounded-full font-bold shadow-md transition-all duration-200 text-xs tracking-wide uppercase mt-1 sm:mt-2">Apply Now</Link>
            </div>
          </div>
        </div>
      </div>
