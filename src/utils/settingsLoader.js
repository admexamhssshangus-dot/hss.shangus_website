...
export const DEFAULT_SETTINGS = {
  ...
  enableAdmin2StepVerification: true,
...
export function mergeSiteSettings(parsed = {}) {
  ...
  return {
    ...
    enableAdmin2StepVerification: parsed.enableAdmin2StepVerification !== undefined ? Boolean(parsed.enableAdmin2StepVerification) : true,
