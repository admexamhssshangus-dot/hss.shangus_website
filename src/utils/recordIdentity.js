...
export function recordIdentity(student = {}) {
  ...
  return {
    ...
    reg: identityKey(s.boardRegNo || s.regNo || s.boardReg || s['Board Registration Number'] || s['Board Registration No.'] || s['Board Registration No'] || s['Board Reg. No.'] || s['Board Reg No'] || s['Registration No. (allotted by JKBOSE)'] || s['Registration No. (allotted by JKBOSE )'] || s['Registration No. (allotted by DIET)'] || s['Registration No.'] || s['Registration No'] || s['Reg. No.'] || s['Reg No'] || s['REG. NO.'] || s['REG NO'] || s['Board Registration No. (Class 10th)'] || s['Board Registration No. (Class 11th)'] || s['Board Registration No. (Class 9th)'] || s['Board Registration No. (Class 8th)'] || s['DIET Registration No.'] || s['DIET/Board Reg. No.'] || s['DIET Reg. No.'] || s['DIET Registration Number']),
